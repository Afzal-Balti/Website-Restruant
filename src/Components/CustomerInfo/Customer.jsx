    ...
    <>
      <div className="md:w-full w-full    bg-[#FBF9F0]">
        ...
        <div className="flex md:flex-row flex-col w-full  ">
          ...
          <div
            data-aos="zoom-in"
            className="md:w-full   my-24 md:p-5 p-0 mx-5 md:ml-[12%] ml-5 "
          >
            <h2 className="py-5 font-exo font-semibold text-3xl">
              Wallet / Payment Gateway
            </h2>
            <div className="data-aos=zoom w-full h-[25%]   bg-[#FDFDFB] rounded-2xl">
            ...
            <div className="w-full h-auto bg-[#FDFDFB] my-14 rounded-md ">
          ...
          <div
            data-aos="zoom-in"
            className="md:w-full w-full   md:my-36  p-5  md:mr-5 mr-0"
          >
            <div className="w-full h-[28%] my-6 bg-[#EA6A12]  rounded-xl">
