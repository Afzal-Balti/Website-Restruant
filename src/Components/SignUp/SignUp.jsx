              ...
              <form onSubmit={handleSubmit(onsubmit)} className="w-full h-auto">
                <div className="md:w-[40%] w-full ">
                  <div className="md:w-full w-full ">
                    <h1 className=" w-full font-medium text-end md:px-14 leading-tight px-8   text-3xl text-[#3C3C3C]">
                      Sign UP
                    </h1>
                    <p className="md:w-full w-full font-myFont  text-end  md:px-10 px-5   text-[#959895] ">
                      Create your account
                    </p>
                  </div>
                </div>
                <div className="md:w-full  my-10 gap-6  flex md:flex-row   flex-col ">
                  ...
                  <div className="md:w-[40%] w-full">
                    <label className="text-[#959895]">Last Name</label>
                    <input
                      type="text"
                      placeholder=""
                      className="w-full border-b border-gray-300 p-3 focus:outline-none focus:ring-0 focus:border-b-2 rounded-3xl"
                ...
                <div className="md:w-full  my-10 gap-6  flex md:flex-row  flex-col ">
                  ...
                  <div className="md:w-[40%] w-full">
                    <label className="text-[#959895]">Phone.No</label>
                    <input
                      type="number"
                      placeholder=""
                      className="w-full border-b border-gray-300 p-3 focus:outline-none focus:ring-0 focus:border-b-2 rounded-3xl"
                ...
                <div className="md:w-[80%] w-full  text-center  ">
                  <div>
                    ...
                    >
                      {loading ? <Loadering /> : <p>Sign Up</p>}
                    </button>
                  </div>

                  <p className="md:w-full  md:my-4 md:py-0 py-10 sm:w-60 text-[#959895] ">
                ...
                <p className="text-center md:w-[80%] w-full font-exo2  text-[#959895]">
                  Already have an account?
                  <span
                    onClick={() => navigate("/login")}
                    className="text-[#EA6112] md:w-[80%] w-full mx-2 font-exo2 cursor-pointer hover:text-orange-500"
                  >
                    Sign In
                  </span>
                </p>
